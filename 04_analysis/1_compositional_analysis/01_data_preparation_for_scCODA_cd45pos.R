...
## Load data
seurat_obj_metadata <- read.csv(paste0(path_r_tables_in, "/post12_cd45pos_alldata_cleaned_final_metadata.csv"))
seurat_obj_metadata
...
write_csv(celllineage_prop_df, file = paste0(path_r_tables_out, "/post12_cd45pos_lineages_counts.csv"))
...
write_csv(celltypesprop_df, file = paste0(path_r_tables_out, "/post12_cd45pos_celltypes_counts.csv"))
