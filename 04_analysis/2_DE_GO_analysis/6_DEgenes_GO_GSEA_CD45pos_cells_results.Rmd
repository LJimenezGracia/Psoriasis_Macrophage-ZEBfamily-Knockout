...
for (index_1 in 1:length(comparison_name_list)) {
  ...
  # Load data
  path_object <- paste0(path_r_objects, "/post12_cd45pos_DEgenes_celltypes_", comparison_name, ".rds")
  ...
  pdf(file = paste0(path_r_figs, "/gg_cd45pos_DEA_MonoMacro_", comparison_name, ".pdf"), width =20, height =15) 
  print(full_plot)    
  dev.off()   
}
```
...
for (index_1 in 1:length(comparison_name_list)) {
  ...
  # Save results
  path_GSEArds <- paste0(path_r_objects, "/GSEA/post12_cd45pos__GSEA_cells_", comparison_name, "_", category_db ,".rds")
  saveRDS(fgsea_vector, file = path_GSEArds)
  
  results_path <- paste0(path_r_tables, "/GSEA/post12_cd45pos__GSEA_cells_", comparison_name, "_", category_db ,".xlsx")
