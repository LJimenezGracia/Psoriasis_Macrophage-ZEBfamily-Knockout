...
for (index in 1:length(comparison_name_list)) {
  ...
  path_object <- paste0(path_r_objects_out, "/post12_cd45neg_DEgenes_lineages_", comparison_name, ".rds")
  path_file <- paste0(path_r_tables, "/post12_cd45neg_DEgenes_lineages_", comparison_name, ".xlsx")
  path_file_split <- paste0(path_r_tables, "/cd45neg_lineages/post12_cd45neg_DEgenes_lineages_", comparison_name, "_UPDOWN.xlsx")
