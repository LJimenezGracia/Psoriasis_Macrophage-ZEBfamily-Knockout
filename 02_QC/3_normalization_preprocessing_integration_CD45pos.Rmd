---
title: "Data normalization and pre-processing: CD45pos"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/post12_cd45pos_filtered.rds"))
seurat_obj
```
...
FeaturePlot(seurat_obj,
            features = c("Ptprc", "Cd3d", "Cd4", "Cd8b1", "Nkg7", "Ms4a1", "Jchain", 
                         "Cd14", "H2-Ab1", "Cd86", "Plac8", "Apoe", "C1qa", "Arg1",
                         "Retnlg", "Mmp8"),
            ncol = 4)
```
...
saveRDS(seurat_obj, paste0(path_r_objects, "/post12_cd45pos_lognorm_processed.rds"))
#seurat_obj <- readRDS(paste0(path_r_objects, "/post12_cd45pos_lognorm_processed.rds"))
```
...
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/post12_cd45pos_lognorm_harmony_processed.rds"))
```
