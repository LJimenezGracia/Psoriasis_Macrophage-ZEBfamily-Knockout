---
title: "Data normalization and pre-processing: Epidermal cells"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/post12_cd45neg_epidermalcells.rds"))
seurat_obj
```
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_cd45neg_epidermalcells_resolution-0.4.xlsx"))
```
...
```{r fig.width=15, fig.height=5}
stromal_genes <- c("Cd34", "Col1a1", "Col3a1")
...
```{r fig.width=15, fig.height=5}
basal_genes <- c("Krt5", "Krt15", "Krt14")

FeaturePlot(seurat_obj_integrated,
            features = basal_genes,
            label = T,
            #split.by = "tissue",
            #order = T,
            pt.size = 0.25,
...
```{r fig.width=20, fig.height=5}
suprabasal_genes <- c("Krt1", "Krt10", "Krt16", "Krt17", "Krt79")

FeaturePlot(seurat_obj_integrated,
            features = suprabasal_genes,
            label = T,
            #split.by = "tissue",
            #order = T,
            pt.size = 0.25,
...
```{r fig.width=15, fig.height=5}
granular_genes <- c("Krt10", "Krt2", "Krt1")

FeaturePlot(seurat_obj_integrated,
            features = granular_genes,
            label = T,
            #split.by = "tissue",
            #order = T,
            pt.size = 0.25,
...
```{r fig.width=15, fig.height=5}
cornified_genes <- c("Sprr2i", "Sprr2d", "Sprr2e")

FeaturePlot(seurat_obj_integrated,
            features = cornified_genes,
            label = T,
            #split.by = "tissue",
            #order = T,
            pt.size = 0.25,
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "Cornified keratinocytes",
  "1" = "Basal keratinocytes",
  "2" = "Basal keratinocytes cycling",
  "3" = "Granular keratinocytes",
  "4" = "Supra-Basal keratinocytes",
  "5" = "Basal keratinocytes cycling",
  "6" = "Stromal cells cycling",
  "7" = "Granular keratinocytes",
 "8" = "Dead keratinocytes",
 "9" = "Basal keratinocytes cycling",
 "10" = "Supra-Basal keratinocytes"
)
...
p1 <- DimPlot(object = seurat_obj_integrated,
  ...
  labs(title = "Epidermal cells")

p1
ggsave(filename = paste0(path_r_figs, "/post12_cd45neg_epidermal_clustering_annotation_umap.png"),
       plot = p1)
```
...
saveRDS(seurat_obj_integrated@meta.data[c("celltypes_2")],
        paste0(path_r_objects, "/post12_cd45neg_epidermal_annotations.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/post12_cd45neg_epidermal_clustering_annotation.rds"))

#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/post12_cd45neg_epidermal_clustering_annotation.rds"))
```
