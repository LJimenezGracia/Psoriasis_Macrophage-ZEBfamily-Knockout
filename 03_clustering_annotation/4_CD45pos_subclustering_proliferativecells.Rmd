---
title: "Data normalization and pre-processing: Proliferative cells"
...
# Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/post12_cd45pos_proliferativecells.rds"))
seurat_obj
```
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/biomarkers_cd45pos_proliferativecells_resolution-0.1.xlsx"))
```
...
TNK_genes <- c("Cd3e", "Cd3d", "Cd4", "Foxp3", "Cd8b1", "Gzma", "Nkg7", 
               "Xcl1", "Klra7", "Klrb1b", "Eomes", "Ncr1")
...
```{r fig.width=20, fig.height=5}
monomacro_genes <- c("Lyz2", "Cd14", "Apoe", "C1qb", "Plac8")
...
```{r fig.width=20, fig.height=5}
LC_genes <- c("Cd207", "Cd24a", "Epcam", "Ptgs1")
...
seurat_obj_integrated <- RenameIdents(
 seurat_obj_integrated,
  "0" = "Proliferative DγδT cells",
  "1" = "Proliferative Macrophages",
  "2" = "Proliferative CD4+ T cells",
  "3" = "Proliferative LC",
  "4" = "Proliferative DETCs",
  "5" = "Proliferative cDC1"
)
...
p1
ggsave(filename = paste0(path_r_figs, "/post12_cd45pos_proliferativecells_clustering_annotation_umap.png"),
       plot = p1)
```
...
saveRDS(seurat_obj_integrated@meta.data[c("celltypes_2")],
        paste0(path_r_objects, "/post12_cd45pos_proliferativecells_annotations.rds"))

# Save processed lognorm Seurat object
saveRDS(seurat_obj_integrated, paste0(path_r_objects, "/post12_cd45pos_proliferativecells_clustering_annotation.rds"))
#seurat_obj_integrated <- readRDS(paste0(path_r_objects, "/post12_cd45pos_proliferativecells_clustering_annotation.rds"))
```
