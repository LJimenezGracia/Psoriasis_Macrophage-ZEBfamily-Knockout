...
## Load Seurat object
seurat_obj <- readRDS(paste0(path_r_objects, "/post12_cd45neg_alldata_cleaned_final_clustering_annotation.rds"))
seurat_obj
...
saveRDS(seurat_obj_markers,
        file = paste0(path_r_objects, "/post12_cd45neg_annotation_full_cleaned_DEA_CellMarkers.rds"))
...
openxlsx::write.xlsx(biomarkers_list,
                     file = paste0(path_r_tables, "/post12_cd45neg_annotation_full_cleaned_DEA_CellMarkers.xlsx"))
